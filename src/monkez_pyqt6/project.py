...
python -m pip install "monkez-pyqt6[all]" pyinstaller
...
def create_project(path: str | Path, *, name: str | None = None, python_version: str = "3.11", run_setup: bool = False) -> Path:
