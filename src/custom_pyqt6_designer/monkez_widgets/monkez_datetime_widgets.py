...
class MonkezCalendarWidget(QCalendarWidget, ThemeSupportMixin):
    ...
    def _update_style(self) -> None:
        ...
        self.setStyleSheet(
            ...
            "font-weight: 650;"
            "}"
            "MonkezCalendarWidget QSpinBox::up-button,"
            "MonkezCalendarWidget QSpinBox::down-button {"
            "width: 0px;"
            "height: 0px;"
            "border: 0;"
            "background: transparent;"
            "}"
            "MonkezCalendarWidget QSpinBox::up-arrow,"
            "MonkezCalendarWidget QSpinBox::down-arrow {"
            "image: none;"
            "width: 0px;"
            "height: 0px;"
            "}"
